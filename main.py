...
def main() -> None:
    ...
    parser.add_argument(
        "--serve",
        action="store_true",
        help="Start the localhost web UI (paste an AI key, optional backup key, or Google OAuth client ID, or use .env)",
    )
    parser.add_argument(
        "--port",
        type=int,
    ...
    try:
        ...
        print(
            ...
            "python main.py --serve — paste an AI key, optional backup key, or "
            "Google OAuth client ID there if .env is empty. "
